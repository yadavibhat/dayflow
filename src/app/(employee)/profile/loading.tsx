        ...
        <div className="max-w-5xl mx-auto px-gutter-mobile md:px-gutter-desktop py-space-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-space-lg">
            <div className="lg:col-span-2 space-y-space-lg">
              {/* About card skeleton */}
              <div className="bg-surface-container-lowest border border-border-light rounded-xl p-space-lg md:p-space-xl shadow-sm">
              ...
              <div className="bg-surface-container-lowest border border-border-light rounded-xl p-space-lg md:p-space-xl shadow-sm">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <div className="h-7 w-28 bg-surface-container-high rounded-full"></div>
                </div>
              </div>
            </div>
            {/* Sidebar skeleton */}
